...
export function Footer() {
  ...
  /* `bg-elevated` (--surface-2), e nao `bg-ink-800`: o valor cru da paleta
     escura deixava o rodape azul-escuro tambem no tema claro, com o texto do
     tema claro (escuro) por cima — ilegivel. */
  return (
