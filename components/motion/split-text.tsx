...
type SplitTextProps = {
   ...
   * só — use quando o texto tiver algum efeito de pintura que não atravesse
   * filhos com transform (`background-clip: text`, por exemplo, some se cada
   * palavra virar camada própria). Nenhum título do site precisa disso hoje.
   */
  mode?: 'word' | 'char' | 'line';
  delay?: number;
  stagger?: number;
