        ...
        <div className="grid gap-14 lg:grid-cols-12 lg:gap-10">
            ...
            <RevealGroup className="mt-10 grid gap-4 sm:grid-cols-2" stagger={0.07}>
              {about.values.map((value) => (
                <RevealItem key={value.title}>
                  <div className="card-surface h-full rounded-card p-5 shadow-e1">
          ...
          <div className="relative min-w-0 lg:col-span-7">
            <Parallax speed={-0.08} className="relative">
              <div className="surface-2 relative overflow-hidden rounded-bento p-8 lg:p-10">
                <div
                  aria-hidden="true"
                ...
                <div className="relative">
                  ...
                  <dl className="grid grid-cols-3 gap-4">
                    {[
                      ...
                      { label: 'Time', value: `${about.team.length} pessoas` },
